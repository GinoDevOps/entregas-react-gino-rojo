                    ...
                    <div className="col-12 text-center text-white">
                        <h3 className="footer__texto">Nuestras <b>Redes:</b></h3>
                            <div className="redes__sociales">
                                ...
                                <a href="https://www.linkedin.com/in/gino-luciano-rojo" target="_blank"> <LinkedinIcon /> </a>
                                <a href="https://github.com/GinoDevOps" target="_blank"> <GithubIcon /> </a>
                            </div>
                    </div>
                </div>
                <div className="footer-final row text-center">
                    <h4 className="text-white">© Developed by Gino Luciano Rojo</h4>
                </div>
            </footer>
        </>
    )
